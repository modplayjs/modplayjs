...
export default defineConfig(({ command }) => ({
  ...
  resolve: {
    alias: [
      ...
      { find: '@modplayjs/fmt-mtm', replacement: resolve(__dirname, '../../packages/fmt-mtm/src/index.ts') },
      { find: '@modplayjs/fmt-stm', replacement: resolve(__dirname, '../../packages/fmt-stm/src/index.ts') },
      { find: '@modplayjs/fmt-669', replacement: resolve(__dirname, '../../packages/fmt-669/src/index.ts') },
      { find: '@modplayjs/fmt-sfx', replacement: resolve(__dirname, '../../packages/fmt-sfx/src/index.ts') },
      { find: '@modplayjs/fmt-digi', replacement: resolve(__dirname, '../../packages/fmt-digi/src/index.ts') },
